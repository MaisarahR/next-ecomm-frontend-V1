...
<div class="hero min-h-screen">
  ...
  <div class="hero-content text-center text-neutral-content">
    <div class="max-w-md">
      ...
      <p class="mb-5 text-white text-glow2">Start your journey with us today and build your brand with an NFT that is uniquely yours.</p>
...
<div class="hero min-h-screen bg-base-200">
  <div class="hero-content flex-col lg:flex-row">
    ...
    <div>
      ...
      <button class="btn btn-primary">View all collections</button>
    </div>
  </div>
</div>
