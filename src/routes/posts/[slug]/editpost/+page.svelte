...
<div class="hero min-h-screen">
  <video autoplay loop muted class="absolute inset-0 w-full h-full object-cover">
    <source src="/pexels_videos_4657-(1080p).mp4" type="video/mp4">
...
<div class="hero min-h-screen bg-base-200">
  <div class="hero-content flex-col lg:flex-row-reverse">
    <div class="text-center">
      ...
      <div class="mt-6">
        <a class="link-hover text-green-400 italic text-xs"  href="/users/signin">Already have one? Click here login.</a>
      </div>
    </div>
    ...
    <div class="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
      <form class="card-body" on:submit={createUser}>
        ...
        <div class="form-control w-full">
          ...
          <input type="text" name="email" placeholder="john@example.com" class="input input-bordered w-full" required />
